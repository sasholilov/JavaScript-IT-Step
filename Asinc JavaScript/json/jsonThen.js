...
const API_URL = "https://my-api.com/endpoint";

const users = fetch(API_URL)
  .then((response) => response.json())
  .then((data) => {
    return data; // JSON data returned by the API
  })
  .catch((error) => {
    throw new Error(error); // Handle any errors that occur during the fetch
  });
